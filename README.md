# OpMigrate（Frontend + Simulated Backend）

OpMigrate 是一个由 VSCode 前端插件和模拟后端服务组成的轻量级算子迁移工具原型，用于展示完整的端到端交互流程，包括：
...
当前版本重点在于“流程跑通”，不涉及真实算子变换、MCTS 搜索、LLVM 编译或性能评测。
